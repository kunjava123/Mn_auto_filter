...
BOT_TOKEN = environ.get('BOT_TOKEN', '6061731326:AAGHFo5EwbHjOOdgfddSwc_lwplbkYVkqqY')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002120341269').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://Dq:Dq@cluster0.fn0n6zt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Dq:Dq@cluster0.fuealiw.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "dq")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+b1qFVq_KFEdlOWFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/mnbots')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002144837006'))
